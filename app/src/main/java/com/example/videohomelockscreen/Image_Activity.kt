...
//        }
    ...
    override fun onCreate(bundle: Bundle?) {
        if (myDataLocal == null) {
            myDataLocal = MYDATA;
            if (MYDATA != null) {
                myDataLocal!!.Image_url = myDataLocal!!.Image_url.replace(
                    "http:",
                    "https:"
                );// not gonna open unsecure connection
            }
            thumbnail = THUMBNAIL;
        }
        Log.d(
            "Image_Activity",
            "Info url ${myDataLocal?.Image_url} name ${myDataLocal?.Image_name} thumbnail ${myDataLocal?.Image_thumbnail}"
        );
        super.onCreate(bundle);
        //activity system and app bar
        MyApp.HideSystemBar(window);//hide system bar
        //update screen orein
        MyApp.checkorein();
        ...
        val loadingdraw = ResourcesCompat.getDrawable(
        ...
        BottomSheetBehavior.from(bottomsheetfragment).apply {
            ...
            val Views =
                LayoutInflater.from(this@Image_Activity).inflate(R.layout.bottom_sheet, null);
...
//                }
            ...
            setWallPaperButton?.setOnClickListener {
                ...
                if (myDataLocal!!.type != UrlType.Image) {
                    ...
                    pref.edit().putString("Media_Type", myDataLocal!!.type.name.lowercase())
                        .apply();//tell the live wallpaper engine what mode to use
                    //save screen rect
                    ...
                    pref.edit().putFloat("Rbottom", screenRect.bottom / Full_video!!.height)
                        .apply();
                    ...
                    val videocomponent =
                        ComponentName(applicationContext, livewallpaper_engines::class.java);
...
//                        livewallpaper.updatewallpaperservice();
                    ...
                    val liveintent = Intent(WallpaperManager.ACTION_CHANGE_LIVE_WALLPAPER).addFlags(
...
//        }
            ...
            Palette.Builder(bitmap).generate { palette ->
                palette?.let { pal ->
                    try {
                        ...
                        val endBackground = ResourcesCompat.getDrawable(
                            resources,
                            R.drawable.bottomsheetshape,
                            theme
                        );
        ...
        if (Wallpaper_Uri.scheme != "content" && Wallpaper_Uri.scheme != "file") {
            ...
            if (Wallpaper_Uri.scheme == "content") {
                ...
                when (myDataLocal!!.type) {// is video
                    UrlType.Video -> {
                        val exoPlayer =
                            ExoPlayer.Builder(this@Image_Activity).build();//video player
                    ...
                    UrlType.Image -> {
                        ...
                        try {
                            //get image info
                            val bitmapWall = this.contentResolver.openFileDescriptor(
                                Wallpaper_Uri,
                                "r"
                            )!!.fileDescriptor;
                            ...
                            val ratio =
                                max(imageWidth / deviceMaxWidth, imageHeight / deviceMaxHeight);
        ...
        setwallpaper_bottom_button?.setOnClickListener {
            ...
            val alert_setwallpaper = AlertDialog.Builder(this, R.style.Base_Theme_VideoHomeLockScreen);

            val buttonlist = LayoutInflater.from(this)
                .inflate(R.layout.setwallpaperalert, null) as ConstraintLayout;
            ...
            buttonlist.findViewById<Button>(R.id.SetHomeScreen).setOnClickListener {
                if (mybitmap == null) {
                    Toast.makeText(this, "please wait for the image to load", Toast.LENGTH_LONG)
                        .show();
                }
                var toast = Toast.makeText(
                    this,
                    "Setting wallpaper to Homescreen please wait",
                    Toast.LENGTH_SHORT
                );
                toast.show();
                setWallpaper(
            ...
            buttonlist.findViewById<Button>(R.id.SetLockScreen).setOnClickListener {
                ...
                var toast = Toast.makeText(
                    this,
                    "Setting wallpaper to lockscreen please wait",
                    Toast.LENGTH_SHORT
                );
                toast.show();
                setWallpaper(
            ...
            buttonlist.findViewById<Button>(R.id.SetBothScreen).setOnClickListener {
                ...
                Toast.makeText(this, "Setting wallpaper to Both please wait", Toast.LENGTH_SHORT)
                    .show();
                setWallpaper(
                    this,
                    mybitmap!!,
        ...
        saveWallpaperButton?.setOnClickListener {
            if (Uri.parse(myDataLocal!!.Image_url).scheme == "content") {
                val speechlist = arrayOf(
                    "why are you saving an already saved wallpaper?",
                    "you know its already on your device right?",
                    "look between you and me. i think this wallpaper doesn't need to be saved :)"
                )
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (loaded) {
                            ...
                            Toast.makeText(
                                this,
                                "Please Wait for the Wallpaper to load",
                                Toast.LENGTH_LONG
                            ).show();
                        }
                    }
